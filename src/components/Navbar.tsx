                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all overflow-hidden border-2 ${
                        ...
                        profile?.role === 'Mentor/Teacher' || profile?.role === 'Mentor' || profile?.role === 'Teacher' ? 'border-indigo-500' : 'border-emerald-500'
                      }`}>
                        {user.photoURL ? (
                    ...
                    {/* Interactive Dropdown Card Overlay */}
                    <AnimatePresence>
                      {isDropdownOpen && (
                        <>
                          ...
                          >
                            ...
                            {/* Dynamic Live Metadata Bento Details */}
                            <div className="p-3.5 space-y-2 border-b border-slate-150">
                              ...
                              <div>
                                ...
                                <div className="text-[9px] text-slate-650 font-bold bg-indigo-50/50 rounded-xl p-2.5 border border-indigo-100/40 leading-snug">
                                  ...
                                  {(profile?.role === 'Mentor/Teacher' || profile?.role === 'Mentor' || profile?.role === 'Teacher') && '✓ High School Club Guidance Desk Level 2'}
                            ...
                            <div className="p-2 space-y-1 bg-slate-50/50">
                              ...
                              {profile?.role === 'Admin' && (
                                <Link
                                  to="/admin-dashboard"
                                  onClick={() => setIsDropdownOpen(false)}
                                  className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold text-[#4f46e5] hover:text-[#4f46e5] hover:bg-purple-primary/5 transition-all group"
                                >
                                  <span className="flex items-center gap-2">
