              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {selectedReport.photoURL && (
                    <div>
                      <span className="text-[8.5px] font-bold text-text-dim uppercase tracking-widest block mb-1">Attached Photo</span>
                      <div className="w-full h-32 rounded-xl overflow-hidden border border-slate-200 shadow-xs relative">
                        <img src={selectedReport.photoURL} alt="Attachment" className="w-full h-full object-cover" />
                      </div>
                    </div>
                  )}
