...
export default function Support() {
  ...
  return (
    <div className="font-sans max-w-md mx-auto py-2 space-y-6 select-none">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border border-slate-150 rounded-2.5xl p-4.5 shadow-sm flex flex-col h-[320px]">
          <div className="flex items-center gap-2 pb-2.5 border-b border-slate-100 shrink-0">
            ...
            <span className="text-[10px] font-extrabold text-slate-900 uppercase tracking-wider block">Bonga Counselling Demo</span>
            <span className="ml-auto text-[8.5px] font-mono text-indigo-600 font-extrabold bg-indigo-50 px-1.5 py-0.5 rounded">SIMULATOR ACTIVE</span>
          </div>
      ...
      <footer className="bg-slate-55 bg-indigo-50/40 border border-indigo-100 text-slate-800 rounded-[2rem] p-5 shadow-xs text-center flex flex-col items-center">
        <HeartHandshake size={24} className="text-indigo-600 mb-2 animate-bounce" />
